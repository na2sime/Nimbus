...
public class AbstractRequestHandler implements IRequestHandler, HttpHandler {
    @Override
    ...
    @Override
    public void sendJsonResponse(HttpExchange exchange, int statusCode, Object object) throws IOException {
        try {
    ...
    @Override
    public void sendResponseEntity(HttpExchange exchange, ResponseEntity<?> responseEntity) throws IOException {
    ...
    @Override
    public <T> T readRequestBodyAsObject(HttpExchange exchange, Class<T> clazz) throws IOException {
